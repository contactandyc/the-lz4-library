...
COPY --chown=dev:dev . /workspace/the-lz4-library
RUN mkdir -p /workspace/build/the-lz4-library && \
    cd /workspace/build/the-lz4-library && \
    cmake /workspace/the-lz4-library && \
